...
ㄴ 작년에 걔한테 듣기로는 1/7이라나 뭐라나. 하여간 ㅈㄹ도 정도껏이지.`,
    hot: false,
  },
  {
    id: 9103,
...
ㄴ 무슨 플라스틱으로 책을 만드냐 ㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋ 그냥 착각이겠지`,
    hot: false,
  },
  {
    id: 5,
...
/* ── 초기 댓글 ───────────────────────────────────────── */
const seedComments = [
  { postId: 2,    author: "ㅇㅇ",    text: "야 아이패드 비번 뭐냐?ㅋㅋ 게시물에 댓글로 그거 142857이래", time: "방금 전" },
  { postId: 9001, author: "익명",    text: "세 번째 파일만 재생하지 마.",                               time: "1분 전" },
  { postId: 1,    author: "ㅇㅇ",    text: "이런 형태 게시판 진짜 오랜만이다",                         time: "2분 전" },
  { postId: 9002, author: "관전자",  text: "작성자가 작성자라고?",                                      time: "3분 전" },
  { postId: 5,    author: "뉴런123", text: "활동 내용이 동아리마다 꽤 다르더라",                       time: "4분 전" },
  { postId: 6,    author: "시간표",  text: "아직 공식 공지는 못 봤어",                                  time: "5분 전" },
];
